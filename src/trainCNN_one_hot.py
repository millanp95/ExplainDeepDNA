...
numEpochs = 100
valSplit = 0.1
modelJsonFile = 'data/'+ dataset +'/architecture_one_hot.json'
modelVisFile =  'data/'+ dataset +'/model_one_hot.png'
bestWeightsFile =  'data/'+ dataset + '/best_weights5_one_hot.h5'
lastWeightsFile =  'data/'+ dataset +'/last_weights5_one_hot.h5'
